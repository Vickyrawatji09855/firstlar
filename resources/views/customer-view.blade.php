...
@section('content')
    ...
    <a href="{{ url('/pdf') }}">
        <button type="button" class="btn btn-primary" style="margin: 10px 0px 10px 1400px">PDF view/Mail karbo</button>
    </a>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $customer->userAddresss->City ?? '' }}</td>
                <td>{{ $customer->userAddresss->state ?? '' }}</td>
                <td>{{ $customer->userAddresss->country ?? '' }}</td>
